        ...
        <Footer container className="border border-t-8 border-teal-500 ">
            <div className=" w-full max-w-7xl mx-auto ">
                <div className='grid w-full justify-between sm:flex md:grid-cols-1'>
                    ...
                    <div className="grid gird-cols gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
                        <div> <Footer.Title title='About' />
                            <Footer.LinkGroup col>
                                ...
                                <Footer.Link href="/about" target="_blank" rel="noopener noreferrer">
                                    Bishal's Blog
                                </Footer.Link>   <Footer.Link href="/home" target="_blank" rel="noopener noreferrer">
                                    Home
                                </Footer.Link>
                ...
                <Footer.Divider />
                <div className=" w-full sm:flex sm:items-center sm:justify-between" > <Footer.Copyright href="#" by="Bishal's blog" year={new Date().getFullYear()} /><div className="flex gap-6 sm:mt-0 mt-4 sm:justify-center">
